...
buildscript {
    ...
    dependencies {
        ...
        // Kotlin 2.4 metadata requires R8 9.1.29 or newer. Override the older
...
subprojects {
    ...
    cloudstream {
        ...
        setRepo(System.getenv("GITHUB_REPOSITORY") ?: "longseespace/cloudstream-provider")
    }

    android {
        namespace = "com.kkphimgenres"
